module random
  !
  ! A module to do things relating to random number generation
  !
...
contains
  ...
  !
  ! A subroutine to get randomly-drawn array of numbers
  !     -- nrand is length of output rand numbers
  !
  subroutine get_randnums(nrand,randnums,rseed)
    integer, intent(in) :: nrand
    real(c_double), intent(out) :: randnums(nrand)
  ...
  end subroutine get_randnums


  !
  ! A subroutine to get randomly-drawn 3D array of numbers
  !     -- nr is length of all 3 dimensions
  !
  subroutine get_randnums_3d(nr,randnums,rseed)
    integer, intent(in) :: nr
    real(c_double), intent(out) :: randnums(nr,nr,nr)
    integer, intent(in), optional :: rseed
