...
contains
  ...
  real(c_double) function deriv1fourth(fp1,fp2,fm1,fm2,h)
    ...
    deriv1fourth = (-fp2 + 8._dp * fp1 - 8._dp * fm1 + fm2) / (12._dp * h)
  ...
  real(c_double) function deriv1_bckwrd2nd(f,fm1,fm2,h)
    ...
    deriv1_bckwrd2nd = (3._dp * f - 4._dp * fm1 + fm2) / (2._dp * h)
  ...
  real(c_double) function deriv1_bckwrd3rd(f,fm1,fm2,fm3,h)
    ...
    deriv1_bckwrd3rd = (c1 * f - 3._dp * fm1 + c2 * fm2 - c3 * fm3) /  h
  ...
  real(c_double) function deriv1_forward2nd(f,fp1,fp2,h)
    ...
    deriv1_forward2nd = (-3._dp * f + 4._dp * fp1 - fp2) / (2._dp * h)
  ...
  real(c_double) function deriv1_forward3rd(f,fp1,fp2,fp3,h)
    ...
    deriv1_forward3rd = (c1 * f + 3._dp * fp1 + c2 * fp2 + c3 * fp3) /  h
  ...
  real(c_double) function deriv2fourth(fp1,fp2,f,fm1,fm2,h)
    ...
    deriv2fourth = (-fp2 + 16._dp * fp1 - 30._dp * f + 16._dp * fm1 - fm2) / (12._dp * h**2 )
  ...
  real(c_double) function deriv2_bckwrd2nd(f,fm1,fm2,fm3,h)
    ...
    deriv2_bckwrd2nd = (2._dp*f - 5._dp*fm1 + 4._dp*fm2 - fm3) / h**2
  ...
  real(c_double) function deriv2_mix(i,j,nx,func,dx)
    ...
    denom = 2._dp * dx * dx ! denominator

    d2fdx2 = deriv2(f_xp1,f,f_xm1,dx) ! second deriv w.r.t x
    d2fdy2 = deriv2(f_yp1,f,f_ym1,dx) ! second deriv w.r.t y

    num = f_xp1yp1 + f_xm1ym1 - 2._dp * f - dx*dx*d2fdx2 - dx*dx*d2fdy2
  ...
  real(c_double) function deriv2_mixfourth_wholestencil(fxp2yp2,fxp2yp1,fxp2ym1,fxp2ym2,fxp1yp2,fxp1yp1,&
    ...
    denom = 12._dp * dx * 12._dp * dy ! denominator

    t1 = fxp2yp2 - 8._dp * fxp2yp1 + 8._dp * fxp2ym1 - fxp2ym2
    t2 = 8._dp * (- fxp1yp2 + 8._dp * fxp1yp1 - 8._dp * fxp1ym1 + fxp1ym2)
    t3 = -8._dp * (- fxm1yp2 + 8._dp * fxm1yp1 - 8._dp * fxm1ym1 + fxm1ym2)
    t4 = - fxm2yp2 + 8._dp * fxm2yp1 - 8._dp * fxm2ym1 + fxm2ym2
  ...
  real(c_double) function deriv2_mixfourth(xi,yi,nx,func,dx)
    ...
    denom = 12._dp * dx * 12._dp * dx ! denominator
