'''
#
# A script to take the variable-chunked ET HDF5 3D data output and make it easier to use
#
...
#         which contains all variables you have output
#    Files will be named after the simulation directory name: <sim_name>_it<it>.hdf5
#
